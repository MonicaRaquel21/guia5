 ...
 */
package sv.edu.udb.autores.util;
 ...
 * @author raque
 */
 @FacesValidator("sv.edu.udb.autores.util.SVPhoneValidator")
public class SVPhoneValidator implements Validator{
    ...
    public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
        ...
        if(!matcher.matches()){
            FacesMessage msg=new FacesMessage("Validacion de telefono fallo.","Formato incorrecto.");
